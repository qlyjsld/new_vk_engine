...
void vk_engine::cloud_init()
{
    ...
    cs_draw.push_back([=](VkCommandBuffer cbuffer) {
        ...
        vmaUnmapMemory(_comp_allocator.vma_allocator,
                       _comp_allocator.get_buffer("camera").allocation);
        ...
        vmaUnmapMemory(_comp_allocator.vma_allocator,
                       _comp_allocator.get_buffer("cloud").allocation);
